...
| `C-x 2` | 横分割 (split-window-below) - 未実装 |
| `C-x 3` | 縦分割 (split-window-right) - 未実装 |
| `C-x 0` | ウィンドウを閉じる (delete-window) - 未実装 |
...
- [ ] **ウィンドウ分割** - 🚧 基盤のみ完了
  ...
  - [ ] C-x 2 (横分割) - プレースホルダーのみ
  - [ ] C-x 3 (縦分割) - プレースホルダーのみ
  - [ ] C-x 0 (ウィンドウを閉じる) - プレースホルダーのみ
  - [ ] C-x 1 (他のウィンドウを閉じる)
